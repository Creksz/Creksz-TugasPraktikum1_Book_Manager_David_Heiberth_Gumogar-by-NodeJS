...
describe('BookManager', () => {
  ...
  test('Test menghapus buku yang tidak ada', () => {
    const removed = bookManager.removeBook("Buku Tidak Ada");
  ...
  test('Test mencari buku berdasarkan author', () => {
    ...
    const booksByAuthorA = bookManager.findBooksByAuthor("Author A");
    expect(booksByAuthorA.length).toBe(2);
    expect(booksByAuthorA).toEqual(expect.arrayContaining([book1, book3]));
  });
